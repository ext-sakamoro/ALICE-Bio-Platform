...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['10 simulations/mo', 'AMBER force field', 'Basic structure prediction', 'Community support'] },
  { name: 'Pro', price: '$299/mo', features: ['Unlimited simulations', 'All force fields (AMBER, CHARMM, OPLS, SDF)', 'Drug screening (SDF-dock)', 'Protein structure prediction', 'Energy decomposition', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited everything', 'GPU-accelerated MD', 'Custom force fields', 'High-throughput screening', 'SLA 99.99%', 'Dedicated support'] },
];
